...
pacstrap /mnt alacritty base base-devel bluez bluez-utils efibootmgr kitty firefox gdm git grub htop intel-ucode linux linux-firmware linux-headers lxsession-gtk3 mpv nautilus neovim net-tools networkmanager ntfs-3g obs-studio openssh papirus-icon-theme pipewire pipewire-alsa pipewire-jack pipewire-media-session pipewire-pulse pulsemixer rofi ttc-iosevka unzip waybar xf86-video-intel &&
