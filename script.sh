...
pacstrap /mnt base base-devel bluez bluez-utils efibootmgr firefox gdm git grub intel-ucode linux linux-firmware linux-headers lxsession-gtk3 mpv nautilus neovim net-tools networkmanager ntfs-3g pipewire pipewire-alsa pipewire-jack pipewire-pulse pulsemixer brightnessctl unzip wireplumber xf86-video-intel &&
