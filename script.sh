...
pacstrap /mnt alacritty base base-devel bluez efibootmgr firefox gdm git gnome-bluetooth gnome-settings-daemon grub htop intel-ucode linux linux-firmware linux-headers lxsession-gtk3 mpv nautilus neovim net-tools networkmanager ntfs-3g obs-studio openssh papirus-icon-theme pipewire pipewire-alsa pipewire-jack pipewire-media-session pipewire-pulse sxhkd xf86-video-intel &&
